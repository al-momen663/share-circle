            ...
            {filteredItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md px-3 py-1 rounded-full text-emerald-600 dark:text-emerald-400 font-bold text-sm shadow-sm">
                      ...
                      {item.originalPrice && item.originalPrice > item.price && (
                        <span className="ml-2 text-[10px] text-gray-400 line-through">${item.originalPrice.toFixed(2)}</span>
                      )}
                    </div>
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-emerald-600 transition-colors">{item.title}</h3>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-50 dark:border-gray-800">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-400">{item.sellerName}</span>
                      </div>
