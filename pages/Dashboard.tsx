        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {statusOptions.map((opt) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-bold transition border ${filter === opt.value
                  ...
                  >
                    <div className="relative h-56">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-wider shadow-lg ${donation.type === DonationType.FOOD ? 'bg-white/90 text-orange-600 backdrop-blur-md' : 'bg-white/90 text-blue-600 backdrop-blur-md'
                          }`}>
                          {donation.type}
                        </span>
                      </div>
                    ...
                    <div className="p-7 flex-grow">
                      ...
                      <div className="pt-6 border-t border-gray-50 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <span className={`px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider ${donation.status === DonationStatus.AVAILABLE ? 'bg-emerald-500 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500'
                          }`}>
                  ...
                  >
                    ...
                    <div className="p-7 flex-grow">
                      ...
                      <div className="pt-6 border-t border-gray-50 dark:border-gray-700 flex justify-between items-center">
                        ...
                        <span className={`px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider ${item.status === MarketItemStatus.AVAILABLE ? 'bg-emerald-500 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500'
                          }`}>
                          {item.status}
                        </span>
                      </div>
                      ...
                      <Popup>
                        <div className="p-1 min-w-[200px]">
                          ...
                          <div className="flex justify-between items-center mb-3">
                            <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-wider ${d.status === DonationStatus.AVAILABLE ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500'
                              }`}>
                              {d.status.replace('_', ' ')}
                            </span>
                          </div>
